...
def main():
    ...
    # 创建数据文件路径（CSMA对比算法）
    file_name_suffix = f"CSMA_{penalty_multiplier}_{gridW}"
    ...
    with open(summary_file, 'w', encoding='utf-8') as f:
        ...
        f.write(f"\n")
        f.write(f"Algorithm: CSMA (Comparison Algorithm, no DRL/GNN)\n")
        f.write("=" * 60 + "\n")
