...
from Compare4_EnvironmentGCN_SAC_new_global import  VEC_env
...
def get_args():
    ...
    # Checkpointing
    parser.add_argument("--save-dir", type=str, default="./save/Compare4_MyCode/model", help="directory in which training state and model should be saved")
...
def main():
    ...
    args.obs_shape = [ 6 for _ in range(args.n_agents)]  # 每一维代表该agent的obs维度
    action_shape = []
